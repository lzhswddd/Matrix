...
namespace nn {
	...
	public:
		...
		*/
		...
		不允许改变矩阵长度
		*/
		void reshape(int row = 0, int col = 0, int channel = 0);
		/**
		@brief 设置矩阵大小
	...
	*/
	...
	/**
	@brief 返回随机生成元素size*1矩阵
	@param low 下界
	@param top 上界
	@param size 矩阵大小
	@param isdouble 是否生成浮点数
	*/
	const Matrix mRand(int low, int top, Size size, bool isdouble = false);
	/**
	@brief 返回随机生成元素size矩阵
	@param low 下界
	@param top 上界
	@param size 矩阵大小
	@param isdouble 是否生成浮点数
	*/
	const Matrix mRand(int low, int top, Size3 size, bool isdouble = false);
	/**
	...
	*/
	...
	/**
	@brief 返回从low到top按gap间隔分割的矩阵
	@param low 下界
	@param top 上界
	@param gap 间隔
	*/
	const Matrix range(int low, int top, double gap = 1);
	/**
	@brief 返回从low到top按gap间隔分割的矩阵
	@param low 下界
	@param top 上界
	@param gap 间隔
	*/
	const Matrix range(double low, double top, double gap = 1);
	/**
	...
	*/
	...
	@param num 次幂
	*/
	const Matrix mPow(const Matrix &src, double num);
	/**
